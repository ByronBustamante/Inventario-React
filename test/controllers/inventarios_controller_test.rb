...
class InventariosControllerTest < ActionController::TestCase
  ...
  test "should create inventario" do
    assert_difference('Inventario.count') do
      post :create, inventario: { fecha: @inventario.fecha, precio: @inventario.precio, producto: @inventario.producto }
    end
  ...
  test "should update inventario" do
    patch :update, id: @inventario, inventario: { fecha: @inventario.fecha, precio: @inventario.precio, producto: @inventario.producto }
    assert_redirected_to inventario_path(assigns(:inventario))
  end
